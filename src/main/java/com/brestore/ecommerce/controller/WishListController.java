...
import com.brestore.ecommerce.dto.product.ProductDto;
import com.brestore.ecommerce.model.Product;
...
import com.brestore.ecommerce.service.WishListService;
...
public class WishListController {
        ...
        public ResponseEntity<ApiResponse> addWishList(@RequestBody Product product, @RequestParam("token") String token) {
                ...
                return new ResponseEntity<ApiResponse>(new ApiResponse(true, "Adicionar a lista de desejos"), HttpStatus.CREATED);
